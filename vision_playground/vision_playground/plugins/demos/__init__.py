...
from .rectify_by_orthogonal_vanishing_points import RectifyByOrthogonalVPDemo
from .multiple_view import AutoCalibrationDemo, TwoViewReconstructionDemo, SfmVideoDemo
...
def register_builtin_demos() -> None:
    ...
    register_demo(RectifyByOrthogonalVPDemo())
    register_demo(TwoViewReconstructionDemo())
    register_demo(AutoCalibrationDemo())
    register_demo(SfmVideoDemo())
