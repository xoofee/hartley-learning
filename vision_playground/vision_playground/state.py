"""
Application state for vision playground: gallery paths, calibration results.
...
class CalibrationResult:
    """Result of calibrateCamera: K, distortion, per-image R/t, errors. image_size is (width, height) of the images K was calibrated for."""
    ...
    image_size: Optional[Tuple[int, int]] = None  # (width, height) of calibration images; used with K
